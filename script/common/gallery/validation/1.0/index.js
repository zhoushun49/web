...
KISSY.add("gallery/validation/1.0/base", function(S, DOM, Event, Util, Define, Field, Warn, Rule) {
    ...
    S.augment(Validation, S.EventTarget, {
        ...
        _initfields: function() {
            ...
            S.each(self.form.elements, function(el) {
                ...
                if(cfg.custumKey && cfg.custumFuc && attr == cfg.custumKey) {
                	Event.on(el,"click", cfg.custumFuc);
                	attr = "";
                }
...
KISSY.add("gallery/validation/1.0/define",function(){
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/field", function (S, DOM, Event, Util, Define, Rule, Remote, Warn) {
    ...
    S.augment(Field, {
        ...
        showMessage: function (est, msg, type) {
            var self = this;
            self.warn.showMessage(est, msg || self["okMsg"], type);
        },
 ...
 * @date 2011.06.21
 */
KISSY.add("gallery/validation/1.0/index", function (S, Validation) {
        return Validation;
}, {
    requires: ["gallery/validation/1.0/base", "gallery/validation/1.0/assets/base.css"]
});/**
 * @fileOverview  校验规则管理
 * @author 常胤 <lzlu.com>
 */

KISSY.add("gallery/validation/1.0/rule", function(S, Util, Rule) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/rule/base", function(S, DOM, Event, Util) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/rule/normal", function(S, DOM, Event, Util, Rule) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/rule/remote", function(S, DOM, Event, Util) {
...
KISSY.add("gallery/validation/1.0/utils", function(S, undefined) {
...
KISSY.add("gallery/validation/1.0/warn", function(S, Util, Warn, BaseClass, Alert, Static, Float) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/warn/alert", function(S, DOM, Event, Util, Define) {
	var symbol = Define.Const.enumvalidsign;
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/warn/base", function(S, DOM, Event, Util, BaseClass) {
...
KISSY.add("gallery/validation/1.0/warn/baseclass", function(S, DOM, Event) {
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/warn/float", function (S, DOM, Event, Util, Define) {
    var symbol = Define.Const.enumvalidsign;
 ...
 * @author 常胤 <lzlu.com>
 */
KISSY.add("gallery/validation/1.0/warn/static", function(S, Node, Util, Define) {
    var symbol = Define.Const.enumvalidsign,
        $ = Node.all;
